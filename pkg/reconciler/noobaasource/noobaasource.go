...
import (
	...
	reconcilernoobaasource "github.com/baum/noobaa-source/pkg/client/injection/reconciler/noobaasources/v1alpha1/noobaasources"
	"github.com/baum/noobaa-source/pkg/reconciler"
	"github.com/baum/noobaa-source/pkg/reconciler/noobaasource/resources"
)

// Reconciler reconciles a NooBaaSource object
...
var _ reconcilernoobaasource.Interface = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, src *v1alpha1.NooBaaSource) pkgreconciler.Event {
...
func makeSinkBinding(src *v1alpha1.NooBaaSource) *sourcesv1.SinkBinding {
