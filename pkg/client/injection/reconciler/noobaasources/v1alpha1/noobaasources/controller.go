...
import (
	...
	versionedscheme "github.com/baum/noobaa-source/pkg/client/clientset/versioned/scheme"
	client "github.com/baum/noobaa-source/pkg/client/injection/client"
	noobaasource "github.com/baum/noobaa-source/pkg/client/injection/informers/noobaasources/v1alpha1/noobaasources"
)

const (
	defaultControllerAgentName = "noobaasource-controller"
	defaultFinalizerName       = "noobaasources.noobaa.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	noobaasourceInformer := noobaasource.Get(ctx)

	lister := noobaasourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "noobaa.knative.dev.NooBaaSource"),
	)
