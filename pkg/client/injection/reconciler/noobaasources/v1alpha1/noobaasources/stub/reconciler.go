...
// reason NooBaaSourceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "NooBaaSourceReconciled", "NooBaaSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for NooBaaSource resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ noobaasource.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ noobaasource.Finalizer = (*Reconciler)(nil)
...
//var _ noobaasource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ noobaasource.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.NooBaaSource) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.NooBaaSource) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.NooBaaSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.NooBaaSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
