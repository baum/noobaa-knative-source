...
// SetDefaults mutates NooBaaSource.
func (s *NooBaaSource) SetDefaults(ctx context.Context) {
	...
	// call SetDefaults against duckv1.Destination with a context of ObjectMeta of NooBaaSource.
